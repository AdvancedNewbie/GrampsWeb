...
CREATE TABLE `mediatags` (
  `id_tagnum` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `id_media` int(11) NOT NULL,
  `id_person` varchar(8) NOT NULL,
  PRIMARY KEY (`id_tagnum`),
  UNIQUE KEY `id_tagnum_UNIQUE` (`id_tagnum`),
  KEY `id_media_idx` (`id_media`),
  KEY `id_person_idx` (`id_person`),
  CONSTRAINT `id_media` FOREIGN KEY (`id_media`) REFERENCES `media` (`id_media`),
  CONSTRAINT `id_person` FOREIGN KEY (`id_person`) REFERENCES `people` (`id_person`)
